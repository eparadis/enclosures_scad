...
Generated by `generate_readme.sh` on Sat Sep  2 16:12:04 PDT 2023.

## `cpe_with_lego/cpe_with_lego.scad`

source: [cpe_with_lego/cpe_with_lego.scad](cpe_with_lego/cpe_with_lego.scad)

![cpe_with_lego](images/cpe_with_lego.png "cpe_with_lego")

## `cpe_with_lego/cust_lego.scad`

source: [cpe_with_lego/cust_lego.scad](cpe_with_lego/cust_lego.scad)

![cust_lego](images/cust_lego.png "cust_lego")

## `desktop_buttons/desktop_buttons.scad`

source: [desktop_buttons/desktop_buttons.scad](desktop_buttons/desktop_buttons.scad)

![desktop_buttons](images/desktop_buttons.png "desktop_buttons")

## `grow_light_clip/light_clip.scad`

source: [grow_light_clip/light_clip.scad](grow_light_clip/light_clip.scad)

![light_clip](images/light_clip.png "light_clip")

## `kaypro_xt/powerswitch_mount.scad`

source: [kaypro_xt/powerswitch_mount.scad](kaypro_xt/powerswitch_mount.scad)

![powerswitch_mount](images/powerswitch_mount.png "powerswitch_mount")

## `lcd_with_protoboard_enclosure/lcd_with_protoboard.scad`

source: [lcd_with_protoboard_enclosure/lcd_with_protoboard.scad](lcd_with_protoboard_enclosure/lcd_with_protoboard.scad)

![lcd_with_protoboard](images/lcd_with_protoboard.png "lcd_with_protoboard")

## `library_test/gears.scad`

source: [library_test/gears.scad](library_test/gears.scad)

![gears](images/gears.png "gears")

## `library_test/mod_gears.scad`

source: [library_test/mod_gears.scad](library_test/mod_gears.scad)

![mod_gears](images/mod_gears.png "mod_gears")

## `one_u_hook/one_u_hook.scad`

source: [one_u_hook/one_u_hook.scad](one_u_hook/one_u_hook.scad)

![one_u_hook](images/one_u_hook.png "one_u_hook")

## `optical_bench_lens_holder/lens_holder.scad`

source: [optical_bench_lens_holder/lens_holder.scad](optical_bench_lens_holder/lens_holder.scad)

![lens_holder](images/lens_holder.png "lens_holder")

## `quarter_inch_tape_head_mount/qit_mount.scad`

source: [quarter_inch_tape_head_mount/qit_mount.scad](quarter_inch_tape_head_mount/qit_mount.scad)

![qit_mount](images/qit_mount.png "qit_mount")

## `rascsi_with_hdd/rascsi_with_laptop_hdd.scad`

source: [rascsi_with_hdd/rascsi_with_laptop_hdd.scad](rascsi_with_hdd/rascsi_with_laptop_hdd.scad)
...
source: [rotating_media/Pulley_T-MXL-XL-HTD-GT2_N-tooth.scad](rotating_media/Pulley_T-MXL-XL-HTD-GT2_N-tooth.scad)
...
source: [tc560_control_handle/sony_tc-560d_control_handle.scad](tc560_control_handle/sony_tc-560d_control_handle.scad)
...
source: [telescope/surplus_optics_adapter.scad](telescope/surplus_optics_adapter.scad)

![surplus_optics_adapter](images/surplus_optics_adapter.png "surplus_optics_adapter")

## `watch_bezel/bezel.scad`

source: [watch_bezel/bezel.scad](watch_bezel/bezel.scad)

![bezel](images/bezel.png "bezel")

## `z80_computer_case/z80_case.scad`

source: [z80_computer_case/z80_case.scad](z80_computer_case/z80_case.scad)
